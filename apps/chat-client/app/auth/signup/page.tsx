  ...
  return (
    <div className='h-screen grid place-items-center bg-gray-800'>
        <NamedCard name='SignUp'>
            ...
            <LabelledInput name='Phone' placeholder='9876543210' type='text' onChange={handleChange} />
            <LabelledInput name='Email' placeholder='johndoe@gmail.com' type='email' onChange={handleChange} />
            <LabelledInput name='Password' placeholder='password' type='password' onChange={handleChange} />
            <Button onClick={handleSubmit}>Sign Up</Button>
            <div className='text-sm text-gray-400'>Already Have a account? <Link href={"/auth/signin"} className='italic underline hover:text-white'>Sign in</Link></div>
        </NamedCard>
    </div>
  )
}
